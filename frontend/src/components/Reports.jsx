...
export default function Reports() {
  ...
  const fetchInitialData = async () => {
    try {
      const [classesRes, subjectsRes] = await Promise.all([
        axios.get("https://school-management-it5j.onrender.com/api/classes"),
        axios.get("https://school-management-it5j.onrender.com/api/subjects"),
      ])
  ...
  const fetchReportData = async () => {
    ...
    try {
      ...
      const response = await axios.get(`https://school-management-it5j.onrender.com/api/reports/${activeTab}`, { params })
      setReportData((prev) => ({
        ...prev,
  ...
  const exportReport = async (format) => {
    try {
      const response = await axios.get(`https://school-management-it5j.onrender.com/api/reports/export/${activeTab}`, {
        params: {
          format,
          startDate: dateRange.startDate,
          endDate: dateRange.endDate,
