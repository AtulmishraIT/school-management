...
export default function Profile() {
  ...
  const handleProfileUpdate = async (e) => {
    ...
    try {
      const response = await axios.put(`https://school-management-it5j.onrender.com/api/user/profile/${user.id}`, profileData)
  ...
  const handlePasswordChange = async (e) => {
    ...
    try {
      await axios.put(`https://school-management-it5j.onrender.com/api/user/password/${user.id}`, passwordData)
  ...
  const handlePreferencesUpdate = async () => {
    setLoading(true)
    try {
      await axios.put(`https://school-management-it5j.onrender.com/api/user/preferences/${user.id}`, preferences)
