...
export default function Notifications() {
  ...
  const fetchNotifications = async () => {
    setLoading(true)
    try {
      const response = await axios.get(`https://school-management-it5j.onrender.com/api/notifications/${user.id}`)
  ...
  const markAsRead = async (notificationIds) => {
    try {
      await axios.put("https://school-management-it5j.onrender.com/api/notifications/mark-read", {
  ...
  const markAsUnread = async (notificationIds) => {
    try {
      await axios.put("https://school-management-it5j.onrender.com/api/notifications/mark-unread", {
        notificationIds: Array.isArray(notificationIds) ? notificationIds : [notificationIds],
      })
  ...
  const deleteNotifications = async (notificationIds) => {
    if (window.confirm("Are you sure you want to delete the selected notifications?")) {
      try {
        await axios.delete("https://school-management-it5j.onrender.com/api/notifications", {
